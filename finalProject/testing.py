...
def record_from_video(input_video_path, output_dir):
    ...
    frame_rate = int(cap.get(cv2.CAP_PROP_FPS))  # Get the original frame rate of the input video
        ...
        while True:
            ...
            if results.multi_hand_landmarks:
                ...
                if not is_recording:
                    ...
                    out = cv2.VideoWriter(output_path, cv2.VideoWriter_fourcc(*'mp4v'), frame_rate, (frame.shape[1], frame.shape[0]))  # Set the frame rate
